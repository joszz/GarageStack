  ...
  <div class="tyre-diagram">
    ...
    <div class="tyre-diagram__wrap">
      <div class="tyre-car-wrap">
        <!--
          ViewBox: 0 0 340 480
          Car: nested SVG cropping orange car from original 500x500 sheet
               (original car bounds: x≈137–245, y≈237–445)
               placed at x=105 y=115, width=130 height=250 in parent coords.
          Wheel corners in parent coords: FL(127,123) FR(213,123) RL(127,349) RR(213,349)
          Indicator lines extend at 45° to FL(72,68) FR(268,68) RL(72,404) RR(268,404)
        -->
        <svg
          viewBox="0 0 340 480"
        ...
        >
          ...
          <template v-if="lightsMainBeam">
            <polygon
              points="127,123 160,110 148,55 100,62"
              class="car-light-beam car-light-beam--main"
            />
            <polygon
              points="213,123 180,110 192,55 240,62"
              class="car-light-beam car-light-beam--main"
            />
          </template>
          <template v-else-if="lightsDippedBeam">
            <polygon points="127,123 148,112 144,82 118,85" class="car-light-beam" />
            <polygon points="213,123 192,112 196,82 222,85" class="car-light-beam" />
          </template>

          <!-- Orange car illustration (top-view) -->
          <!-- Nested SVG crops the orange car from original 500×500 coordinate space -->
          <svg viewBox="137 237 108 208" x="105" y="115" width="130" height="250">
            ...
            />
            <!-- Bottom black stripe / bumper bar -->
            <path
            ...
            />
            <!-- Interior bars (left, center, right) -->
            <path
              class="car-svg-body"
            ...
            />
            <!-- Windscreen / body gloss highlights -->
            <polygon
              class="car-svg-gloss"
          ...
          <!-- Tyre pressure indicator lines (leader lines from wheel corner outward) -->
          <!-- Front-left -->
          <line
            x1="127"
            y1="123"
        ...
        <!-- Tyre pressure labels (positioned at outer ends of indicator lines) -->
